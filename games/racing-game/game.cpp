...
const float ACCELERATION = 150.0f; // Much slower acceleration
const float DECELERATION = 100.0f; // Scaled deceleration
const float BRAKE_FORCE = 250.0f; // Scaled brake force
